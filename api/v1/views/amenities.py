...
handling CRUD operations for amenity resources.'''
...
'''Define the list of HTTP methods allowed for the amenities endpoint.'''
...
def handle_amenities(amenity_id=None):
    '''The Dispatcher method handler for the amenities endpoint request.
    '''
    handlers = {
        'GET': get_amenities,
...
def add_amenity(amenity_id=None):
    '''Creates a new amenity with data from the request body.
    '''
...
def update_amenity(amenity_id=None):
    '''Updates an existing amenity with the specified ID..
    '''
